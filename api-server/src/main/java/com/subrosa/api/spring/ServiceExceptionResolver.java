...
public class ServiceExceptionResolver extends DefaultHandlerExceptionResolver {
     ...
     * @return A {@link ModelAndView} containing an appropriate {@link NotificationList}.
     */
    ...
    /**
     * Catch-all handler for {@link FileNotFoundException} exceptions.
     * @param ex  Exception to handle
    ...
    /**
     * Catch-all handler for {@link HttpMediaTypeNotSupportedException} exceptions.
     * @param ex Exception to handle
     * @param request The servlet request
     * @param httpServletResponse The servlet response
     * @return A {@link ModelAndView} containing an appropriate {@link NotificationList}.
